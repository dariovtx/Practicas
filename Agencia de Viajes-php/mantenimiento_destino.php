...
echo '<td>'.$fila[1].'</td>';
echo '<td>'.$fila[2].'</td>';
echo '<td><a href="editar_destino.php?cod='.$fila[0].'"> <img src="img/editar.svg" height="30"
width="30" title="EDITAR DESTINO"> </a></td>';
echo '<td><a href="eliminar_destino.php?cod='.$fila[0].'"> <img src="img/eliminar.svg" height="30"
width="30" title="ELIMINAR DESTINO"> </a></td>';
echo '</tr>';
}
echo '</table>';
echo '<br>';
