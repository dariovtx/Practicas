...
$ciu=$_POST['txt_ciu'];
$dir=$_POST['txt_dir'];
mysqli_query($conexion, "update destinos set des_ciu='".$ciu."' ,des_dir='".$dir."' where des_cod='".$cod."'") or
die("Error al Guardar".mysqli_error($conexion));
include_once 'mantenimiento_destino.php';
...
<h1 class="register-title">EDITAR DESTINO</h1>
<form name="destino" class="register" action="editar_destino.php" method="post">
<center>
<table>
<tr>
<td> <b> Código: </b> </td>
